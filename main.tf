...
resource "aws_vpc_endpoint" "this" {
  ...
  security_group_ids  = lookup(each.value, "service_type", "Interface") == "Interface" ? distinct(concat(local.default_security_groups, lookup(each.value, "security_group_ids", []))) : null
