...
resource "aws_vpc_endpoint" "this" {
  ...
  security_group_ids  = lookup(each.value, "service_type", "Interface") == "Interface" ? distinct(concat([aws_security_group.allow_all_internal.id], var.security_group_ids, lookup(each.value, "security_group_ids", []))) : null
